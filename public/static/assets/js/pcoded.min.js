"use strict";
console.log("navbar js worked")
function menuhrres() {
  $(window)[0].innerWidth < 768
    ? setTimeout(function () {
...
function togglemenu() {
  ...
  0 == $(".pcoded-navbar").hasClass("theme-horizontal") &&
    (e <= 1200 && e >= 992 && $(".pcoded-navbar").addClass("navbar-collapsed"),
...
$(document).ready(function () {
  ...
  function s(e) {
    $(".header-chat .main-friend-chat").append(
      '<div class="media chat-messages"><div class="media-body chat-menu-reply"><div class=""><p class="chat-cont">' +
        $(".h-send-chat").val() +
        '</p></div><p class="chat-time">now</p></div></div>'
    ),
      d($(".h-send-chat").val()),
      i(),
  ...
  function d(e) {
    setTimeout(function () {
      ...
      setTimeout(function () {
        (document.getElementsByClassName("rem-msg")[0].innerHTML =
          "<p class='chat-cont'>hello superior personality you write</p> <p class='chat-cont'>" +
          e +
          "</p>"),
  ...
  if (
    ...
    var o = $(window)[0].innerWidth;
    o < 992 || $(".pcoded-navbar").hasClass("menupos-static")
...
$(window).scroll(function () {
      ...
      d = {
        ...
        HandleSubMenuTrigger: function () {
          ...
          if (1 == $(".pcoded-navbar").hasClass("theme-horizontal"))
            if (d >= 768) {
              var i = $(
                ".pcoded-inner-navbar .pcoded-submenu > li.pcoded-hasmenu"
              );
              i.off("click")
                    ...
                    function () {
                      if (
                        ...
                        if (d + i <= $(window).width())
                          ...
                          $(".sidenav-inner").css({
                            "margin-left":
                              parseInt(o.slice(12, o.length - 3)) - 80,
                          }),
                            $(".sidenav-horizontal-prev").removeClass(
                              "disabled"
                            );
                        }
                      }
            ...
            case "horizontal":
              "hover" === e.SubMenuTrigger
                ...
                : $("li.pcoded-hasmenu").on("click", function (e) {
                    if (
                      (e.preventDefault(), $(".pcoded-submenu", this).length)
                    ) {
                      var s = $(".pcoded-submenu:first", this),
                        d = s.offset(),
                        i = d.left,
  ...
  $("#mobile-collapse,#mobile-collapse1").click(function (e) {
    $(window)[0].innerWidth < 992 &&
      ($(".pcoded-navbar").toggleClass("mob-open"), e.stopPropagation());
  }),
  $(window).ready(function () {
    ...
    $(".pcoded-navbar").on("click tap", function (e) {
      ...
      $(".pcoded-main-container,.pcoded-header").on("click", function () {
        e < 992 &&
          1 == $(".pcoded-navbar").hasClass("mob-open") &&
...
$("body").append(
  "" +
    ...
    '<a href="https://appseed.us/" target="_blank" class="btn btn-md btn-primary">' +
    '<i class="fa fa-rocket" aria-hidden="true"></i> More Starters' +
    "</a> " +
    "</div>" +
    ""
);
